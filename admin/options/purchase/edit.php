...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Змінити товар</li>
  </ol>
</nav>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mr-2" name="date" placeholder=2020-10-04 value="<?php echo $purchase["date"]?>">
                            </div>
                        </div>
                    </div>
